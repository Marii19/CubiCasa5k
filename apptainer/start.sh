...
apptainer run --nv --bind CubiCasa5k:/mnt/code --bind ${DATAPOOL3}/datasets/cubicasa5k:/mnt/datasets/cubicasa --bind ${LOCAL_JOB_DIR}:/mnt/output CubiCasa5k/apptainer/cubi_no_torch.sif bash /mnt/code/apptainer/eval.sh
